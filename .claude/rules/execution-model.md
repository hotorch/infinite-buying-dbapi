---
description: Advisor/Worker delegation model — how the main session delegates implementation to subagents, when Workers report to the Advisor, and how Workers handle Advisor feedback.
paths: ["**"]
---
