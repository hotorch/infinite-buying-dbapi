  ...
  return (
    <section className="selectedDetails" aria-labelledby="selected-date-title">
      ...
      <div className="detailColumns">
        ...
        <div><h4>비교</h4><dl><div><dt>전략 수익률</dt><dd>{percent(day.equity / capital - 1)}</dd></div><div><dt>QQQ 수익률</dt><dd>{percent(day.qqq_equity / capital - 1)}</dd></div><div><dt>현재 낙폭</dt><dd>{percent(day.drawdown)}</dd></div></dl></div>
